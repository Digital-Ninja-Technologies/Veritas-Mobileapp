                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(
                            fontSize: 15, color: AppColors.subText2),
                      ).also((w) => Row(children: [
                            Text('${_greeting()}, ',
                                style: const TextStyle(
                                    fontSize: 15, color: AppColors.subText2)),
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const FxDetailScreen())),
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 18, vertical: 16),
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                                colors: [AppColors.yellow, Color(0xFFFFF49B)],
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('Hold money in 6 currencies',
                                        style: TextStyle(
                                            fontSize: 14.5,
                      ...
                      Row(
                        ...
                        children: [
                          Text(isClient ? 'Your contracts' : 'Active contracts',
                              style: const TextStyle(
                                  fontSize: 17,
                                  fontWeight: FontWeight.w800,
                                  color: AppColors.darkText,
...
class _BalanceCard extends StatelessWidget {
  ...
  const _BalanceCard(
      {required this.user, required this.isClient, required this.ref});
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(isClient ? 'Client wallet' : 'Available balance',
                  style: const TextStyle(
                      fontSize: 13,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Text('USD Wallet',
                        style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.w600,
                            color: Color(0xFFE9E7CF))),
                  ],
                ),
              ),
            ],
          ...
          GestureDetector(
            onTap: () => Navigator.push(context,
                MaterialPageRoute(builder: (_) => const FxDetailScreen())),
            child: Row(
              children: [
                Text('≈ ${formatNGN(balance)}',
                    style: const TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w600,
                        color: AppColors.yellow)),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Text('\$1 = ₦${fxRate.toStringAsFixed(2)}',
                          style: const TextStyle(
                              fontSize: 11.5,
                              fontWeight: FontWeight.w600,
                              color: AppColors.yellow)),
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Icons.download_outlined,
                            color: AppColors.darkText, size: 17),
                        const SizedBox(width: 8),
                        Text(isClient ? 'Withdraw' : 'Withdraw to NGN',
                            style: const TextStyle(
                                fontSize: 14.5,
                                fontWeight: FontWeight.w700,
                                color: AppColors.darkText)),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(isClient ? Icons.add : Icons.currency_exchange,
                            color: Colors.white, size: 17),
                        const SizedBox(width: 8),
                        Text(isClient ? 'Add funds' : 'Convert',
                            style: const TextStyle(
                                fontSize: 14.5,
                                fontWeight: FontWeight.w700,
                                color: Colors.white)),
...
class _StatsStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final earned =
        contracts.fold<double>(0, (sum, c) => sum + c.completedAmount);
    ...
    return Row(
      children: [
        ...
        Expanded(
          ...
          label: user.role == UserRole.freelancer
              ? 'Total earned'
              : 'Total released',
          ...
          children: [
            ...
            Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text(
                    '${contract.completedMilestones}/${contract.milestones.length} milestones',
                    style: const TextStyle(

...
class _SupportChatScreenState extends ConsumerState<SupportChatScreen> {
  ...
  String _autoReply(String input) {
    if (input.contains('withdraw'))
      return 'Withdrawals typically arrive within 2–4 business hours. If it\'s been longer than 24 hours, please share your reference number and I\'ll investigate right away.';
    if (input.contains('dispute'))
      return 'Dispute cases are reviewed within 48 hours. Our resolution team examines both parties\' evidence. You can track your case status on the contract detail screen.';
    if (input.contains('kyc'))
      return 'KYC verification usually takes 1–2 business hours after you submit your documents. Make sure the photos are clear and all corners of the document are visible.';
    if (input.contains('login') ||
        input.contains('log in') ||
        input.contains('password'))
      return 'For login issues, try resetting your password via the login screen. If you\'re still having trouble, I can escalate to our security team.';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const Text('Veritas support · Online',
                            style: TextStyle(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.support_agent_outlined,
                color: AppColors.darkText, size: 30),
          ),
          const SizedBox(height: 16),
          const Text('Hi! I\'m Tomi 👋',
              style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w800,
                  color: AppColors.darkText)),
          ...
          Flexible(
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 14,
                    color: fromUser ? Colors.white : AppColors.darkText,
                    height: 1.5),
              ),
            ),
          ),
...
class _DotState extends State<_Dot> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          ...
          height: 6,
          decoration: BoxDecoration(
            color: AppColors.subText.withValues(alpha: 0.3 + _anim.value * 0.7),
            shape: BoxShape.circle,
          ),
        ),
      );

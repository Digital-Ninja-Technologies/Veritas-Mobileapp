                  ...
                  children: [
                        ...
                        child: Row(
                            ...
                            children: [
                              const Icon(Icons.mail_outline,
                                  color: Color(0xFF6E3FCF), size: 19),
                              ...
                              Expanded(
                                  child: Column(
                                      ...
                                      children: [
                                    const Text('Awaiting freelancer',
                                        style: TextStyle(
                                            fontSize: 13,
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('Total in escrow',
                                        style: TextStyle(
                                            fontSize: 12.5,
                                            color: Color(0xFFC9C6A6))),
                                    const SizedBox(height: 4),
                                    Text(formatUSD(contract.totalAmount),
                                        style: const TextStyle(
                                            fontSize: 32,
                                            fontWeight: FontWeight.w800,
                                            color: Colors.white,
                                            letterSpacing: -0.8)),
                                    const SizedBox(height: 3),
                                    Text('≈ ${formatNGN(contract.totalAmount)}',
                                        style: const TextStyle(
                                            fontSize: 13,
                            ...
                            children: [
                              ...
                              Text(
                                isClient
                                    ...
                                    : 'Funds released when client approves your work',
                                style: const TextStyle(
                                    fontSize: 12, color: Color(0xFFC9C6A6)),
                              ),
                            ],
                          ),
                        ],
                            ...
                            Expanded(
                                child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: const [
                                  Text('Have a problem with this contract?',
                                      style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w700,
                                          color: Colors.white)),
                                  SizedBox(height: 2),
                                  Text('Chat with support or raise a dispute',
                                      style: TextStyle(
                                          fontSize: 12,
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) =>
                                  DisputeScreen(contract: contract))),
                      child: Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            Icon(Icons.warning_amber_outlined,
                                color: AppColors.redDark, size: 17),
                            SizedBox(width: 8),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                            ...
                            children: [
                              Text(formatUSD(milestone.amount),
                                  style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w800,
                                      color: AppColors.darkText)),
                              const SizedBox(height: 2),
                              Text(formatNGN(milestone.amount),
                                  style: const TextStyle(
                            ...
                            children: [
                              ...
                              if (milestone.deliveryLink != null) ...[
                                ...
                                Row(children: [
                                  ...
                                  Expanded(
                                      child: Text(milestone.deliveryLink!,
                                          style: const TextStyle(
                                              fontSize: 12.5,
                                              fontWeight: FontWeight.w700,
                    ...
                    if (milestone.changeNote != null) ...[
                      ...
                      Container(
                        padding: const EdgeInsets.all(12),
                        decoration: BoxDecoration(
                            color: const Color(0xFFFCE7DD),
                            border: Border.all(color: const Color(0xFFF3CBB6)),
                            borderRadius: BorderRadius.circular(12)),
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                    ...
                    if (milestone.disputeRef != null) ...[
                      ...
                      Container(
                        padding: const EdgeInsets.all(12),
                        decoration: BoxDecoration(
                            color: const Color(0xFFFCE2E0),
                            border: Border.all(color: const Color(0xFFF0C0BB)),
                            borderRadius: BorderRadius.circular(12)),
                        child: Row(children: [
                          const Icon(Icons.warning_amber,
                              color: AppColors.redDark, size: 13),
                          const SizedBox(width: 7),
                          Expanded(
                              child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                Text('Dispute ${milestone.disputeRef}',
                                    style: const TextStyle(
                                        fontSize: 10.5,
                                        fontWeight: FontWeight.w700,
                                        color: AppColors.redDark,
                    ...
                    if (showReject) ...[
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => RequestChangesScreen(
                                    contractId: contractId,
                                    milestone: milestone))),
                        child: Container(
                          padding: const EdgeInsets.symmetric(vertical: 11),
    ...
    if (milestone.status == MilestoneStatus.submitted ||
      ...
      if (isClient) {
        final ok = await showVConfirm(context,
            title: 'Release ${formatUSD(milestone.amount)}?',
            body:
                'This releases funds into the freelancer\'s wallet. The action can\'t be recalled once confirmed.',
            confirmLabel: 'Release');
        if (ok != true) return;
        // Optimistic local update so the UI responds instantly...
        ref.read(contractsProvider.notifier).updateMilestone(contractId,
            milestone.id, milestone.copyWith(status: MilestoneStatus.released));
        try {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (_) => SubmitWorkScreen(
                  contractId: contractId, milestone: milestone)));
    }
  }
}
...
String _disputeStatusLabel(DisputeStatus? status) {
  switch (status) {
    case DisputeStatus.underReview:
      return 'Under review · Funds stay locked while we review the case.';
    case DisputeStatus.resolved:
      return 'Resolved · Funds have been returned to the client.';
    default:
      return 'Dispute opened · Our team will review within 48 hours.';
  }
}
...
class _MilestoneBadge extends StatelessWidget {
  ...
  (String, Color, Color) _badge() {
    switch (status) {
      case MilestoneStatus.released:
        return ('Released', AppColors.activeBadgeBg, AppColors.greenDark);
      case MilestoneStatus.submitted:
        return ('Submitted', const Color(0xFFFFF3CC), AppColors.gold);
      case MilestoneStatus.inReview:
        return ('In review', const Color(0xFFFFF3CC), AppColors.gold);
      case MilestoneStatus.changesRequested:
        return ('Changes req.', const Color(0xFFFCE7DD), AppColors.orange);
      case MilestoneStatus.inProgress:
        return ('In progress', AppColors.completeBadgeBg, AppColors.blue);
      case MilestoneStatus.inDispute:
        return ('In dispute', const Color(0xFFFCE2E0), AppColors.redDark);
      case MilestoneStatus.refunded:
        return ('Refunded', const Color(0xFFE3ECFF), AppColors.blue);
      default:
        return ('Pending', AppColors.lightBg, AppColors.subText);
    }
  }
}
...
Widget _BadgeFor(String badge) {
  ...
  switch (badge) {
    case 'Complete':
      bg = AppColors.completeBadgeBg;
      fg = AppColors.completeBadgeFg;
      break;
    case 'In dispute':

  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/phone-input': (_) => const PhoneInputScreen(country: '', dialCode: '',),
        '/personal-details': (_) => const PersonalDetailsScreen(country: '', phone: '',),
        '/create-password': (_) => const CreatePasswordScreen(firstName: '', middleName: '', lastName: '', dob: '', email: '', phone: '', country: '',),
